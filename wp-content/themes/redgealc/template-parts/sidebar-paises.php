<div class="aside-country-select ">
	...
	<h4 class="mb-0"><?php pll_e('PAÍSES DE LA'); ?><br>RED GEALC</h4>

	<h5><?php pll_e('PERFILES Y ACTIVIDADES'); ?></h5>

	<div class="input-group filtro-form">
		<input type="text" class="form-control" placeholder="<?php pll_e('Buscar País'); ?>" id="list-paises" onkeyup="filter_data('list-paises', 'a')">
