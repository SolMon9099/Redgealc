...
<div id="eventos" class="eventos_list">
	<div class="row">
		<?php
            if (is_front_page()) { ?>
		<div class="col-6">
			<h2 class="orange mb-0"><?php pll_e('Últimos'); ?><br><?php pll_e('EVENTOS'); ?></h2>
		</div>
		<div class="col-6 d-flex justify-content-end align-items-end">
			<button type="button" class="btn btn-link"><?php pll_e('VER TODOS LOS EVENTOS'); ?></button>
		</div>
		...
		<div class="col">
			...
			<div class="card h-100">
				...
				<div class="card-footer">
					...
					<a href="<?php the_permalink(); ?>" class="read-more float-end stretched-link"> 
