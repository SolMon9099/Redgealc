...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Montserrat:wght@300;400;700&display=swap" rel="stylesheet">
...
<body <?php body_class(); ?>>
	...
	<section id="header2" class="border-bottom">
		<nav class="navbar navbar-expand-lg navbar-light bg-light py-2 py-md-3 py-lg-5" aria-label="navbar">
			<?php
