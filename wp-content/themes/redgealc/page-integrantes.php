      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-md-7 col-lg-8">
            <h6 class="description-primary mb-2 mb-md-4"><?php echo the_content(); ?></h6>
            <?php get_template_part('template-parts/integrantes-pais-persona', 'none'); ?>
          </div>
