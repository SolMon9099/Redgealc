	...
	<section id="#">
		...
		<div class="container main-content">
			<div class="row">
				<div class="col-lg-12">
					<?php if ( !is_paged() ) {
					 get_template_part('template-parts/eventos-list-destacados', 'none'); 
}?>
					<?php get_template_part('template-parts/eventos-list', 'none'); ?>



				</div>
				<?php //get_template_part('template-parts/home-sidebar', 'none'); ?>
			</div>
		</div>
	</section>
